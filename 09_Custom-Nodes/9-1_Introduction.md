...
You can save this custom node as a .dyf file and add it to your library under  *File > Import Library*. Once you have imported the custom node, you should see it in the category specified when the node was created.
