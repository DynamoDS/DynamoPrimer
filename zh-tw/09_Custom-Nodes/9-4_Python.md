...
![](images/9-4/pythonlogo.jpg)Python 是使用廣泛的程式設計語言，其備受青睞與其語法樣式有很大關係。Python 的可讀性很高，因此較許多其他語言更容易瞭解。Python 支援模組與套件，可嵌入至既有應用程式中。本節中的範例假定您對 Python 有基本瞭解。若要取得有關如何正常使用 Python 的資訊，[Python.org](https://www.python.org/) 上的[「入門」](https://www.python.org/about/gettingstarted/)頁面是良好的資源。
...
**視覺程式：**![](images/9-4/python-nodes.jpg)
...
![腳本編輯器](images/9-4/Exercise/Python/python04.jpg)
