...
> 1. Utilisez le nœud *"Select Model Element"*, et cliquez sur le bouton *"Select"* (ou *"Change"*). Dans la fenêtre Revit, sélectionnez l'élément souhaité. Dans ce cas, l'élément sélectionné est le volume du bâtiment.
