...
![Exercise](images/10-4/pythonRevit.png)
...
### Exercise 01
>Create a new Revit Project.  Download the example file that accompanies this exercise (Right click and "Save Link As..."). A full list of example files can be found in the Appendix. [Revit-Doc.dyn](datasets/10-5/Revit-Doc.dyn)
...
![Exercise](images/10-4/Exercise/Revit/Images/RevitPython - 06.png)
