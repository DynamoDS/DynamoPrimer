...
###Zero-Touch Packages
Zero-touch packages are a good complement to user-defined custom nodes.  A few packages which use C# libraries are listed in the table below. For more detailed information on packages, visit the [Packages section ](../Appendix-A_Resources/A-3_packages.md)in the Appendix.
...
>Download and unzip the example files that accompany this package case study (Right click and "Save Link As..."). A full list of example files can be found in the Appendix. [Zero-Touch-Examples.zip](datasets/11-5/Zero-Touch-Examples.zip).
...
![Exercise](images/11-5/import.jpg)
>1. In Dynamo, create a new file and select *File > Import Library...*

![Exercise](images/11-5/folder.jpg)
...
![Exercise](images/11-5/library.jpg)
...
>Download and unzip the example files that accompany this package case study (Right click and "Save Link As..."). A full list of example files can be found in the Appendix. [ZeroTouchImages.zip](datasets/11-5/ZeroTouchImages.zip)
